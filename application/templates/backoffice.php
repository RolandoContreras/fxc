      ...
      <nav class="navbar-mobile">
        <div class="container-fluid">
          <ul class="navbar-mobile__list list-unstyled">
            ...
            <li><a href="<?php echo site_url().'backoffice/profile';?>"><i class="fas fa-chart-bar"></i>Perfil</a></li>
            ...
            <li><a href="<?php echo site_url().'backoffice/finance';?>"><i class="fas fa-table"></i>Finanzas</a></li>
            <li><a href="<?php echo site_url().'backoffice/pay';?>"><i class="fas fa-calendar-alt"></i>Cobros</a></li>
            <li><a href="<?php echo site_url().'backoffice/range';?>"><i class="fas fa-map-marker-alt"></i>Rangos</a></li>
            <li class="has-sub"><a class="js-arrow" href="#"><i class="fas fa-copy"></i>Material</a>
              <ul class="list-unstyled navbar__sub-list js-sub-list">
      ...
      <div class="menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
          <ul class="list-unstyled navbar__list">
            ...
            <li><a href="<?php echo site_url().'backoffice/finance';?>"><i class="fas fa-table"></i>Finanzas</a></li>
            <li><a href="<?php echo site_url().'backoffice/pay';?>"><i class="far fa-check-square"></i>Cobros</a></li>
            <li><a href="<?php echo site_url().'backoffice/range';?>"><i class="fas fa-calendar-alt"></i>Rangos</a></li>
            <li class="has-sub"><a class="js-arrow" href="#"><i class="fas fa-copy"></i>Material</a>
              <ul class="list-unstyled navbar__sub-list js-sub-list">
                <li><a href="<?php echo site_url().'backoffice/tools';?>">Material Red</a></li>
                <li><a href="<?php echo site_url().'backoffice/tools_legal';?>">Documentos Legales</a></li>
