                            ...
                            <div id="trx_sc_layouts_title_171490811" class="sc_layouts_title sc_align_center with_content without_image without_tint">
                              <div class="sc_layouts_title_content">
                                <div class="sc_layouts_title_title">
                                  <h1 class="sc_layouts_title_caption">Club privado &#038; <br/>Membresias vacacionales</h1>
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <article id="post-109" class="post_item_single post_type_post post_format_ post-109 post type-post status-publish format-standard has-post-thumbnail hentry category-news tag-ideas tag-info">
              <div class="header_content_wrap header_align_mc">
                <div class="post_featured">
                    <img width="1920" height="1080" src="<?php echo site_url().'static/page_front/images/travelx1920.jpg';?>" class="attachment-rhodos-thumb-full size-rhodos-thumb-full wp-post-image" alt="Membresías Vacacionales" itemprop="url" srcset="<?php echo site_url().'static/page_front/images/travelx1920.jpg';?> 1920w, <?php echo site_url().'static/page_front/images/travelx500.jpg';?> 500w, <?php echo site_url().'static/page_front/images/travelx300.jpg';?> 300w, <?php echo site_url().'static/page_front/images/travelx768.jpg';?> 768w, <?php echo site_url().'static/page_front/images/travelx1024.jpg';?> 1024w, <?php echo site_url().'static/page_front/images/travelx370.jpg';?> 370w, <?php echo site_url().'static/page_front/images/travelx1230.jpg';?> 1230w, <?php echo site_url().'static/page_front/images/travelx800.jpg';?> 800w, <?php echo site_url().'static/page_front/images/travelx390.jpg';?> 390w, <?php echo site_url().'static/page_front/images/travelx270.jpg';?> 270w" sizes="(max-width: 1920px) 100vw, 1920px" />
                </div>
              </div>
              <div class="post_content post_content_single entry-content" itemprop="mainEntityOfPage">
                <p>Dentro de la corporación tenemos membresías vacacionales que te ayudaran a realizar tus más profundos sueños. Puedes encontrar con nosotros Resort y hoteles 5 estrellas desde 9$ la noche, un precio que en el mercado está sobre los $300 normalmente, una membresía vacacional en el mercado tiene un valor sobre los $50 000 (dólares americanos) por persona con nosotros lo obtienes por ser parte de nuestra corporación. </p>
                <p>Las membresías son de uso exclusivo de los inversionistas de la corporación y tiene una duración de 5 años renovables, pensamos en múltiples formas de hacer multiplicar tu dinero pero a la vez también pensamos en un crecimiento integral y los viajes con tus seres queridos para disfrutar el mundo es fundamental en este camino por obtener tus sueños</p>
                <blockquote>
                  <p>Creemos en un crecimiento integral y eso incluye disfrutar del mundo, ven y disfruta momento inolvidable con tus seres queridos.</p>
                </blockquote>
                <h4>¿Resort 5 estrellas a 9$ por noche?</h4>
                <p>El Caribe, el viejo continente (Europa) y los países más desarrollados, sueños que quizás estaban en nuestra imaginación. Ahora están al alcance de tu mano solo por ser parte de BCA CAPITAL. Nunca es tarde para disfruta los beneficios que solo unos pocos tienen.</p>
                <p>BCA CAPITAL absorbió el 95% del costo de las membresías para que todos nuestros socios puedan disfrutar de estilo de vida que merecen.</p>
                <p>Ven y disfruta de todo lo que el mundo tiene para ti.</p>
              </div>
          </article>
  </div>
  <!--START ASIDE-->
