      ...
      <div class="page_content_wrap">
        <div class="content_wrap">
          <div class="content">
              ...
              <section class="elementor-element elementor-element-ef50e98 elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-inner-section" data-id="ef50e98" data-element_type="section">
              <div class="elementor-container elementor-column-gap-no">
                <div class="elementor-row">
                  <div class="elementor-element elementor-element-217ebc6 sc_inner_width_none sc_layouts_column_icons_position_left elementor-column elementor-col-100 elementor-inner-column" data-id="217ebc6" data-element_type="column">
          ...
          <div class="elementor-container elementor-column-gap-extended">
            ...
            <article id="post-109" class="post_item_single post_type_post post_format_ post-109 post type-post status-publish format-standard has-post-thumbnail hentry category-news tag-ideas tag-info">
              <div class="header_content_wrap header_align_mc">
                <div class="post_featured">
                    <img width="1920" height="1080" src="<?php echo site_url().'static/page_front/images/fund.jpg';?>" class="attachment-rhodos-thumb-full size-rhodos-thumb-full wp-post-image"
                    alt="Fondo de Inversiones" itemprop="url" srcset="<?php echo site_url().'static/page_front/images/fund.jpg';?> 1920w, <?php echo site_url().'static/page_front/images/fundx500.jpg';?> 500w, <?php echo site_url().'static/page_front/images/fundx300.jpg';?> 300w, <?php echo site_url().'static/page_front/images/fundx768.jpg';?> 768w, <?php echo site_url().'static/page_front/images/fund-1024.jpg';?> 1024w, <?php echo site_url().'static/page_front/images/fund-370.jpg';?> 370w, <?php echo site_url().'static/page_front/images/fund-1230.jpg';?> 1230w, <?php echo site_url().'static/page_front/images/fund-800.jpg';?> 800w, <?php echo site_url().'static/page_front/images/fund-390.jpg';?> 390w, <?php echo site_url().'static/page_front/images/fund-270.jpg';?> 270w" sizes="(max-width: 1920px) 100vw, 1920px" />
                </div>
              </div>
              <div class="post_content post_content_single entry-content" itemprop="mainEntityOfPage">
                <p>Hemos creado un fondo de inversiones para que cualquier persona que quiera tener una oportunidad de multiplicar su dinero los pueda hacer con nosotros.</p>
                <p>Contamos con un starff de profesionales en el sector finanzas que ayudarán a multiplicar la inversión con bajos riesgos. Durante más de 8 años nuestros profesionales vienen trabajando en compañías prestigiosa de Latinoamérica siendo los operadores más prestigiosos de la región.</p>
                <p>No solamente en el mundo de las finanzas son reconocidos sino que a través de distintos medio de comunicación masiva como radio y televisión han sido entrevistando dando asesorías y cursos a nivel internacional.</p>
                <blockquote>
                  <p>La rentabilidad que nuestros socios tienen con el fondo de inversiones oscilan entre un 4 al 8% mensual según el reporte del último año obtenido.</p>
                </blockquote>
                <p>Cada inversionista tendrá acceso a su inversión en todo momento, a través de una plataforma que proporciona el bróker. Hay ciertos requisitos que se necesita para aperturar una cuenta con nosotros, los cuales menciono a continuación.</p>
                <h4>¿Cómo ser parte del fondo de inversiones?</h4>
                <p>Cualquier persona con deseo de multiplicar su dinero puede ser parte de BCA CAPITAL, lo mínimo que solicitamos es tener una inversión de $250 (dólares americanos) sin tope máximo.</p>
                <ul>
                  <li>Registrarse en nuestro sistema de forma gratuita</li>
                  <li>Llenar una ficha de registro (datos completos).</li>
                  <li>Firmar el contrato con la corporación.</li>
                  <li>Hacer el depósito al numero de cuenta corriento al bróker .</li>
                </ul>
                <!--<p><iframe src="https://player.vimeo.com/video/154709932" width="640" height="360" frameborder="0" allowfullscreen></iframe></p>-->
                <p>Luego de cumplir con los requisitos antes mencionados nuestros traders comienza a hacer las operaciones obteniendo todos los meses la rentabilidad mencionada anteriormente. Si desea más información por favor comuníquese con nosotros.</p>
              </div>
          </article>
  </div>
  <!--START ASIDE-->
  <div class="sidebar widget_arearight" role="complementary">
              ...
              <div class="post_content">
                    ...
                    <div class="post_info">
                        <span class="post_info_item post_categories">
                            <a href="<?php echo site_url().'course';?>" title="Ir a la información">Ir al servicio</a>
                        </span>
                  </div>
              </div>
        </article>
        <article class="post_item with_thumb">
          <div class="post_thumb">
            <a href="<?php echo site_url().'club';?>">
                <img width="90" height="90" src="<?php echo site_url().'static/page_front/images/club.jpg';?>" class="attachment-rhodos-thumb-tiny size-rhodos-thumb-tiny wp-post-image" alt="Club y membresias vacacionales" srcset="<?php echo site_url().'static/page_front/images/club.jpg';?> 90w, <?php echo site_url().'static/page_front/images/club-400.jpg';?> 400w, <?php echo site_url().'static/page_front/images/club-150.jpg';?> 150w, <?php echo site_url().'static/page_front/images/club-370.jpg';?> 370w" sizes="(max-width: 90px) 100vw, 90px" />
            </a>
          </div>
          <div class="post_content">
                <h6 class="post_title">
                    <a href="<?php echo site_url().'club';?>">Club privado &#038; Membresias vacacionales</a>
                </h6>
                <div class="post_info">
                    <span class="post_info_item post_categories">
                        <a href="<?php echo site_url().'club';?>" title="Ir a la información">Ir al servicio</a>
                    </span>
              </div>
          </div>
        </article>
