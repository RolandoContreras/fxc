                            ...
                            <table id="zero-configuration" class="display table nowrap table-striped table-hover dataTable" style="width: 100%;" role="grid"
                              ...
                              <thead>
                                <tr role="row">
                                  ...
                                  <th class="sorting" tabindex="0" aria-controls="zero-configuration" rowspan="1" colspan="1" style="width: 197px;"
                                    aria-label="Office: activate to sort column ascending">Porcentaje</th>
                              ...
                              <tbody>
                                ...
                                <td>
                                    <div class="operation">
                                            <div class="btn-group">
                                               <button class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="key-act-button" type="button" onclick="edit_bonus('<?php echo $value->bonus_id;?>');"><span>Editar</span></button>
                                            </div>
                                    </div>
                                </td>
                            </tr>
