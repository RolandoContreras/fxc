                ...
                <div class="navbar navbar-static navbar_as_heading">
                        <div class="navbar-inner">
                                <div class="container" style="width: auto;">
                                        <a class="brand"></i> Formulario de Factura</a>
                                </div>
                        </div>
                </div>
              <strong>ID:</strong><br>
              <input type="text" value="<?php echo isset($obj_invoices->invoice_id)?$obj_invoices->invoice_id:"";?>" class="input-xlarge-fluid" placeholder="ID" disabled="">
              <input type="hidden" id="invoice_id" name="invoice_id" value="<?php echo isset($obj_invoices->invoice_id)?$obj_bonus->invoice_id:"";?>">
              <br><br>
              <strong>Nombre:</strong><br>
              <input type="text" id="name" name="name" value="<?php echo isset($obj_invoices->name)?$obj_invoices->name:"";?>" class="input-xlarge-fluid" placeholder="Name">
              <br><br>
