                            ...
                            <div id="trx_sc_layouts_title_171490811" class="sc_layouts_title sc_align_center with_content without_image without_tint">
                              <div class="sc_layouts_title_content">
                                <div class="sc_layouts_title_title">
                                  <h1 class="sc_layouts_title_caption">Cursos &#038; Asesoramientos<br/>En el mercado secundario</h1>
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <article id="post-109" class="post_item_single post_type_post post_format_ post-109 post type-post status-publish format-standard has-post-thumbnail hentry category-news tag-ideas tag-info">
              <div class="header_content_wrap header_align_mc">
                <div class="post_featured">
                    <img width="1920" height="1080" src="<?php echo site_url().'static/page_front/images/coursex1920.jpg';?>" class="attachment-rhodos-thumb-full size-rhodos-thumb-full wp-post-image" alt="Fondo de Inversiones" itemprop="url" srcset="<?php echo site_url().'static/page_front/images/coursex1920.jpg';?> 1920w, <?php echo site_url().'static/page_front/images/coursex500.jpg';?> 500w, <?php echo site_url().'static/page_front/images/coursex300.jpg';?> 300w, <?php echo site_url().'static/page_front/images/coursex768.jpg';?> 768w, <?php echo site_url().'static/page_front/images/coursex1024.jpg';?> 1024w, <?php echo site_url().'static/page_front/images/coursex370.jpg';?> 370w, <?php echo site_url().'static/page_front/images/coursex1230.jpg';?> 1230w, <?php echo site_url().'static/page_front/images/coursex800.jpg';?> 800w, <?php echo site_url().'static/page_front/images/coursex390.jpg';?> 390w, <?php echo site_url().'static/page_front/images/coursex270.jpg';?> 270w" sizes="(max-width: 1920px) 100vw, 1920px" />
                </div>
              </div>
              <div class="post_content post_content_single entry-content" itemprop="mainEntityOfPage">
                ...
                <p>Los módulos para ser un trader profesional se dividen en 3:</p>
                <ul>
                  <li>Básico</li>
                  <li>Intermedio</li>
                  <li>Avanzando</li>
                </ul>
                <h4>Nuestro Trader Master</h4>
                <p>Uno de nuestros trader master y a la vez profesor de nuestra corporación es el Adm. Gabriel Gutiérrez con más de 8 años de experiencia en el mercado bursátil.</p>
                <p>Especialista en finanzas de la Universidad Nacional Mayor de San Marcos. Ejerció durante 4 años como trader para el X-Trader Brokers (XTB). En los últimos años, se ha desempeñado como asesor de inversiones bursátiles para Sudamérica y Europa. </p>
                <p>Algunas de sus publicaciones en los medios de comunicación masiva.</p>
                <ul>
                    <li><a href="https://elcomercio.pe/economia/peru/xdirect-dolar-tomara-impulso-primeros-meses-2017-231161" target="_blank">https://elcomercio.pe/economia/peru/xdirect-dolar-tomara-impulso-primeros-meses-2017-231161</a></li>
                    <li><a href="http://www.metodotrading.com/pe/ponente/gabriel-gutierrez" target="_blank">http://www.metodotrading.com/pe/ponente/gabriel-gutierrez</a></li>
                    <li><a href="https://www.youtube.com/watch?v=ECOh5Ob6EsM" target="_blank">https://www.youtube.com/watch?v=ECOh5Ob6EsM</a></li>
                    <li><a href="https://www.youtube.com/watch?v=eloe-OGOOxE" target="_blank">https://www.youtube.com/watch?v=eloe-OGOOxE</a></li>
                    <li><a href="https://gestion.pe/tu-dinero/consejos-rentabilizar-su-grati-2150946" target="_blank">https://gestion.pe/tu-dinero/consejos-rentabilizar-su-grati-2150946</a></li>
                    <li><a href="https://gestion.pe/tu-dinero/gratificaciones-entre-ahorrar-invertir-gastar-excedentes-2150566" target="_blank">https://gestion.pe/tu-dinero/gratificaciones-entre-ahorrar-invertir-gastar-excedentes-2150566</a></li>
                </ul>
              </div>
              <p>Todos los módulos tendrán un descuesto de hasta un 60% del precio que se encuentra en el mercado y al terminar los tres módulos tendrán la oportunidad de trabajar directamente como operador nuestro en BCA CAPITAL.</p>
          </article>
  </div>
  <!--START ASIDE-->
